 ...
 * 
 * A complete binary tree where parent node is always less than or equal to its children.
 * Useful for: Priority Queues (min priority), finding Kth smallest element, Dijkstra's algorithm
 * 
 * Time Complexities:
 * - Insert: O(log n)
 * - Delete Min: O(log n)
...
public class MinHeap {
    ...
    /**
     * Delete the minimum element (root) from heap
     * Process:
     ...
     * In min heap, minimum element is always at root (index 0)
    ...
    /**
     * Heapify down - maintain min heap property by moving element down
     ...
     * @param array Array to convert to min heap
     */
     ...
     * Strategy: Decrease element to minimum value, then delete min
    ...
    public void deleteAt(int index) {
        ...
        // Decrease the value to minimum and then extract min
    ...
    /**
     * Main method to demonstrate MinHeap operations
    ...
    public static void main(String[] args) {
        ...
        heap.print(); // Should show min heap property
        ...
        System.out.println("\n=== Testing BuildHeap ===");
        int[] testArray = {9, 3, 5, 1, 4, 2};
        MinHeap heap2 = new MinHeap(10);
        heap2.buildHeap(testArray);
        System.out.println("Heap built from array [9, 3, 5, 1, 4, 2]:");
        heap2.print();
        
        // Test decreaseKey and deleteAt
        System.out.println("\n=== Testing Advanced Operations ===");
        System.out.println("Decreasing key at index 2 to 0:");
        heap2.decreaseKey(2, 0);
        heap2.print();
